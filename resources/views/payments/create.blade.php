                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('booking_id') is-invalid @enderror" id="booking_id" name="booking_id" required>
                                        ...
                                        @foreach($bookings as $booking)
                                            <option value="{{ $booking->id }}" {{ old('booking_id') == $booking->id ? 'selected' : '' }}>{{ $booking->booking_reference }} - {{ $booking->guest->full_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('booking_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('payment_gateway_id') is-invalid @enderror" id="payment_gateway_id" name="payment_gateway_id">
                                        ...
                                        @foreach($paymentGateways as $gateway)
                                            <option value="{{ $gateway->id }}" {{ old('payment_gateway_id') == $gateway->id ? 'selected' : '' }}>{{ $gateway->name }}</option>
                                        @endforeach
                                    </select>

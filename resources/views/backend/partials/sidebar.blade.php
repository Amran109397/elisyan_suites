    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section">
            <div class="section-header">
                <a href="{{ route('dashboard') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="front-desk" data-role="super_admin,property_manager,receptionist">
            ...
            <div class="collapse show" id="frontDeskCollapse">
                <ul class="subsection-list">
                    ...
                    <li>
                        <a href="{{ route('check-outs.index') }}" class="subsection-link">
                            <i class="fas fa-sign-out-alt"></i> Check-outs
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-assignments.index') }}" class="subsection-link">
                            <i class="fas fa-door-open"></i> Room Assignments
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('waiting-list.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="room-management" data-role="super_admin,property_manager,receptionist">
            ...
            <div class="collapse" id="roomManagementCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('properties.index') }}" class="subsection-link">
                            <i class="fas fa-building"></i> Properties
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-types.index') }}" class="subsection-link">
                            <i class="fas fa-th-large"></i> Room Types
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('rooms.index') }}" class="subsection-link">
                    ...
                    <li>
                        <a href="{{ route('amenities.index') }}" class="subsection-link">
                            <i class="fas fa-concierge-bell"></i> Room Amenities
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-images.index') }}" class="subsection-link">
                            <i class="fas fa-images"></i> Room Images
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-amenities.index') }}" class="subsection-link">
                            <i class="fas fa-concierge-bell"></i> Room Amenities
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-status-logs.index') }}" class="subsection-link">
                            <i class="fas fa-clipboard-list"></i> Room Status Logs
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-section" id="housekeeping" data-role="super_admin,property_manager,housekeeping">
            ...
            <div class="collapse" id="housekeepingCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('housekeeping-staffs.index') }}" class="subsection-link">
                            <i class="fas fa-user-friends"></i> Housekeeping Staff
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('housekeeping-tasks.index') }}" class="subsection-link">
                            <i class="fas fa-tasks"></i> Housekeeping Tasks
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('maintenance-issues.index') }}" class="subsection-link">
                            <i class="fas fa-tools"></i> Maintenance Issues
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-section" id="financial" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="financialCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('payments.index') }}" class="subsection-link">
                            <i class="fas fa-money-bill-wave"></i> Payments
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('invoices.index') }}" class="subsection-link">
                            <i class="fas fa-file-invoice"></i> Invoices
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('accounts-payable.index') }}" class="subsection-link">
                            <i class="fas fa-hand-holding-usd"></i> Accounts Payable
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('accounts-receivable.index') }}" class="subsection-link">
                            <i class="fas fa-money-check-alt"></i> Accounts Receivable
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('expenses.index') }}" class="subsection-link">
                            <i class="fas fa-receipt"></i> Expenses
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('taxes.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="pos" data-role="super_admin,property_manager,pos_staff">
            ...
            <div class="collapse" id="posCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('pos-outlets.index') }}" class="subsection-link">
                            <i class="fas fa-store-alt"></i> POS Outlets
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pos-categories.index') }}" class="subsection-link">
                            <i class="fas fa-tags"></i> POS Categories
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pos-products.index') }}" class="subsection-link">
                            <i class="fas fa-box"></i> POS Products
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pos-orders.index') }}" class="subsection-link">
                            <i class="fas fa-shopping-cart"></i> POS Orders
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pos-payments.index') }}" class="subsection-link">
                            <i class="fas fa-cash-register"></i> POS Payments
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pos-inventory.index') }}" class="subsection-link">
                            <i class="fas fa-warehouse"></i> POS Inventory
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('menus.index') }}" class="subsection-link">
                            <i class="fas fa-utensils"></i> Menus
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('room-service-orders.index') }}" class="subsection-link">
                            <i class="fas fa-room-service"></i> Room Service
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-section" id="inventory" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="inventoryCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('inventory-categories.index') }}" class="subsection-link">
                            <i class="fas fa-folder"></i> Inventory Categories
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('inventory-items.index') }}" class="subsection-link">
                            <i class="fas fa-box-open"></i> Inventory Items
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('inventory-stocks.index') }}" class="subsection-link">
                            <i class="fas fa-warehouse"></i> Inventory Stocks
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('inventory-transactions.index') }}" class="subsection-link">
                            <i class="fas fa-exchange-alt"></i> Inventory Transactions
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('purchase-orders.index') }}" class="subsection-link">
                            <i class="fas fa-file-invoice-dollar"></i> Purchase Orders
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('suppliers.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="guest-relations" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="guestRelationsCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('guest-preferences.index') }}" class="subsection-link">
                            <i class="fas fa-heart"></i> Guest Preferences
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('loyalty-programs.index') }}" class="subsection-link">
                            <i class="fas fa-star"></i> Loyalty Programs
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('loyalty-members.index') }}" class="subsection-link">
                            <i class="fas fa-users-cog"></i> Loyalty Members
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('loyalty-points.index') }}" class="subsection-link">
                            <i class="fas fa-coins"></i> Loyalty Points
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('feedback.index') }}" class="subsection-link">
        ...
        <!-- Pricing & Packages -->
        <div class="sidebar-section" id="pricing" data-role="super_admin,property_manager">
            <div class="section-header" data-bs-toggle="collapse" data-bs-target="#pricingCollapse">
                <i class="fas fa-tag section-icon"></i>
                <span class="section-title">Pricing & Packages</span>
                <i class="fas fa-chevron-down section-arrow"></i>
            </div>
            <div class="collapse" id="pricingCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('prices.index') }}" class="subsection-link">
                            <i class="fas fa-dollar-sign"></i> Prices
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('packages.index') }}" class="subsection-link">
                            <i class="fas fa-gift"></i> Packages
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('promo-codes.index') }}" class="subsection-link">
                            <i class="fas fa-ticket-alt"></i> Promo Codes
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('seasons.index') }}" class="subsection-link">
        ...
        <!-- Services & Add-ons -->
        <div class="sidebar-section" id="services-addons" data-role="super_admin,property_manager">
            <div class="section-header" data-bs-toggle="collapse" data-bs-target="#servicesAddonsCollapse">
                <i class="fas fa-concierge-bell section-icon"></i>
                <span class="section-title">Services & Add-ons</span>
                <i class="fas fa-chevron-down section-arrow"></i>
            </div>
            <div class="collapse" id="servicesAddonsCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('services.index') }}" class="subsection-link">
                            <i class="fas fa-concierge-bell"></i> Services
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('addons.index') }}" class="subsection-link">
                            <i class="fas fa-plus-circle"></i> Add-ons
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('booking-services.index') }}" class="subsection-link">
                            <i class="fas fa-clipboard-list"></i> Booking Services
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('booking-addons.index') }}" class="subsection-link">
                            <i class="fas fa-plus-square"></i> Booking Add-ons
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('booking-modifications.index') }}" class="subsection-link">
                            <i class="fas fa-edit"></i> Booking Modifications
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-section" id="channel-management" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="channelCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('channels.index') }}" class="subsection-link">
                            <i class="fas fa-plug"></i> Channels
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('channel-properties.index') }}" class="subsection-link">
                            <i class="fas fa-link"></i> Channel Properties
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('channel-bookings.index') }}" class="subsection-link">
                            <i class="fas fa-calendar-alt"></i> Channel Bookings
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('channel-sync-logs.index') }}" class="subsection-link">
                            <i class="fas fa-sync"></i> Channel Sync Logs
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-section" id="events" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="eventsCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('events.index') }}" class="subsection-link">
                            <i class="fas fa-calendar-alt"></i> Events
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('event-bookings.index') }}" class="subsection-link">
                            <i class="fas fa-ticket-alt"></i> Event Bookings
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('resources.index') }}" class="subsection-link">
                            <i class="fas fa-cubes"></i> Resources
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('event-resources.index') }}" class="subsection-link">
                            <i class="fas fa-tasks"></i> Event Resources
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('treatments.index') }}" class="subsection-link">
                            <i class="fas fa-spa"></i> Treatments
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('therapists.index') }}" class="subsection-link">
                            <i class="fas fa-user-md"></i> Therapists
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('appointments.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="asset-management" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="assetCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('asset-categories.index') }}" class="subsection-link">
                            <i class="fas fa-folder-open"></i> Asset Categories
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('assets.index') }}" class="subsection-link">
                            <i class="fas fa-couch"></i> Assets
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('asset-maintenance.index') }}" class="subsection-link">
                            <i class="fas fa-wrench"></i> Asset Maintenance
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('asset-depreciation.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="reports" data-role="super_admin,property_manager">
            ...
            <div class="collapse" id="reportsCollapse">
                <ul class="subsection-list">
                    <li>
                        <a href="{{ route('reports.index') }}" class="subsection-link">
                            <i class="fas fa-file-alt"></i> Reports
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('scheduled-reports.index') }}" class="subsection-link">
                            <i class="fas fa-clock"></i> Scheduled Reports
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('analytics.index') }}" class="subsection-link">
                            <i class="fas fa-chart-pie"></i> Analytics
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('financial-reports.index') }}" class="subsection-link">
        ...
        <div class="sidebar-section" id="system-admin" data-role="super_admin">
            ...
            <div class="collapse" id="systemAdminCollapse">
                <ul class="subsection-list">
                    ...
                    <li>
                        <a href="{{ route('user-properties.index') }}" class="subsection-link">
                            <i class="fas fa-building-user"></i> User Properties
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('currencies.index') }}" class="subsection-link">

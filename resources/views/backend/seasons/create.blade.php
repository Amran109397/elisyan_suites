        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New Season</h3>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('price_adjustment') is-invalid @enderror" id="price_adjustment" name="price_adjustment" value="{{ old('price_adjustment') }}" step="0.01" required>

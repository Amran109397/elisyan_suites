        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Housekeeping Staff</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('housekeeping-staffs.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('housekeeping-staffs.index') }}" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

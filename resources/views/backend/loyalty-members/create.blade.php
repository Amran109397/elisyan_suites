        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Loyalty Member</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('loyalty-members.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('loyalty_program_id') is-invalid @enderror" id="loyalty_program_id" name="loyalty_program_id" required>
                                        ...
                                        @foreach($loyaltyPrograms as $loyaltyProgram)
                                            <option value="{{ $loyaltyProgram->id }}">{{ $loyaltyProgram->name }}</option>
                                        @endforeach
                                    </select>

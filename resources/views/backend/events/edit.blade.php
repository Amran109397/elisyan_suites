                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('property_id') is-invalid @enderror" id="property_id" name="property_id" required>
                                        ...
                                        @foreach($properties as $property)
                                            <option value="{{ $property->id }}" {{ old('property_id', $event->property_id) == $property->id ? 'selected' : '' }}>{{ $property->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('property_id')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('setup_time') is-invalid @enderror" id="setup_time" name="setup_time" value="{{ old('setup_time', $event->setup_time) }}" min="0">
                                    @error('setup_time')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('cleanup_time') is-invalid @enderror" id="cleanup_time" name="cleanup_time" value="{{ old('cleanup_time', $event->cleanup_time) }}" min="0">
                                    @error('cleanup_time')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>

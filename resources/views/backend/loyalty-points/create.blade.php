        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Loyalty Points</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('loyalty_member_id') is-invalid @enderror" id="loyalty_member_id" name="loyalty_member_id" required>
                                        ...
                                        @foreach($loyaltyMembers as $loyaltyMember)
                                            <option value="{{ $loyaltyMember->id }}">{{ $loyaltyMember->guest->full_name }} ({{ $loyaltyMember->membership_number }})</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        <option value="earned" {{ old('type', 'earned') == 'earned' ? 'selected' : '' }}>Earned</option>
